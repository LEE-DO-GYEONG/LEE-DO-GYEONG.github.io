---
layout: post
title: pygame_project
date: 2021-12-25 13:30:00 -0500
categories: [Visual_Studio, pygame_project] 
...
# 배경 만들기
background = pygame.image.load(os.path.join(image_path, "white.png"))
...
# 공 크기에 따른 최초 스피드
ball_speed_y = [-18, -15, -12, -9]  # index 0, 1, 2, 3 에 해당하는 값  ex) -18 = balloon1의 속도
...
while running:
    ...
    # 무기 위치 조정
    weapons = [[w[0], w[1] - weapon_speed] for w in weapons]  # 무기 위치를 위로 보냄
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                # 가장 작은 크기의 공이 아니라면 다음 단계의 공으로 쪼개기
                if ball_img_idx < 3:
